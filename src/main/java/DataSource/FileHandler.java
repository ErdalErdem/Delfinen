    ...
    public ArrayList<Medlem> læsData () {
        ...
        try {
            ...
            while (sc.hasNextLine()){
                ...
                boolean success;
                try {
                    KonkurrenceMedlem readMedlem = new KonkurrenceMedlem(
                    ...
                    readMedlem.setTræningsresultat(Integer.parseInt(attributes[6]));
                    readMedlem.setDato(attributes[7]);
                    readMedlem.setKonkurrence(attributes[8]);
                    readMedlem.setStævne(attributes[9]);
                    readMedlem.setPlacering(Integer.parseInt(attributes[10]));
                    readMedlem.setTid(Integer.parseInt(attributes[11]));
        ...
        try { //Try catch exception for the file handling
            ...
            for (Medlem m : medlemmer) { //Printer alle attributter for medlemmerne i csv filen
                if (m instanceof KonkurrenceMedlem km){
                    ...
                    ps.print(";");
                    ps.print(km.getTræningsresultat());
                    ps.print(";");
                    ps.print(km.getDato());
                    ps.print(";");
                    ps.print(km.getKonkurrence());
                    ps.print(";");
                    ps.print(km.getStævne());
                    ps.print(";");
                    ps.print(km.getPlacering());
                    ps.print(";");
                    ps.print(km.getTid());
                    ps.println();
                }
